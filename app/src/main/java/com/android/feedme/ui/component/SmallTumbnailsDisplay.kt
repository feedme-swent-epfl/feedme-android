 ...
 */
@Composable
fun SmallThumbnailsDisplay(listRecipe: List<Recipe>, navigationActions: NavigationActions, recipeViewModel: RecipeViewModel) {
  ...
  LazyVerticalGrid(columns = GridCells.Adaptive(minSize = imageWidth.dp),
      userScrollEnabled = false, modifier = Modifier.height(gridHeight.dp)) {
